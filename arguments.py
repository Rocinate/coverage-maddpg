...
def parse_args():
    ...
    parser.add_argument("--max_episode_len", type=int, default=45, help="maximum episode length")
    ...
    should be saved")
    parser.add_argument("--old_model_name", type=str, default="models/simple_spread_0214_200636_82000/", help="directory in \
