...
def parse_args():
    ...
    parser.add_argument("--max_episode_len", type=int, default=70, help="maximum episode length")
    ...
    parser.add_argument("--safe_control", type=bool, default=False, help="adopt the CBF ")
    ...
    # evaluation
    parser.add_argument("--model_name", type=str, default="models/simple_coverage_0509_172713_26000/",
